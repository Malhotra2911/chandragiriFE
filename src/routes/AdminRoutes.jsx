...
import Pauti from '../screens/Admin/Donation/ManualDonation/ChequeDonationManual/pauti';
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/admin-panel/manualdonation/pauti"
          element={
            <Adminprivateroute>
              <Pauti setopendashboard={setopendashboard} />
            </Adminprivateroute>
          }
        />
