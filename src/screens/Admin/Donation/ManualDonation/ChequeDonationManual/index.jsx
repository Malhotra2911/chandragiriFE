...
const ChequeDonation = ({
  ...
  const [pautiId, setPautiId] = useState('')
  ...
  const handlePauti = () => {
    ...
    navigation('/admin-panel/manualdonation/pauti')
  }
    ...
    try {
      ...
      if (
        ...
        const data = {
          ...
          donation_item: JSON.stringify(donationItems),
        }


        const res = await axios.post(`${backendApiUrl}admin/manual-donation`, data, {
          headers: {
        ...
        if (res.data.status === true) {
          ...
          const clickedButtonId = pautiId;
          console.log(clickedButtonId)

          if (clickedButtonId === 'generatePautiButton') {
            navigation('/admin-panel/manualdonation/pauti', {
              state: {
  ...
  return (
    <Box>
      <ThemeProvider theme={theme}>
        <form onSubmit={addChequeDonation} encType="multipart/form-data">
          ...
          <Grid container rowSpacing={2} columnSpacing={5}>
            ...
            <Grid item xs={12} md={6}>
              <CustomInputLabel htmlFor="cheque">
                Cheque Upload
              </CustomInputLabel>
              <CustomInput
                accept="image/*"
          ...
          >
            ...
            <Button
              ...
              variant="contained"
              onClick={(e) => setPautiId(e.target.id)}
              id='generatePautiButton'
              type="submit"
            >
              Generate Pauti
            </Button>
