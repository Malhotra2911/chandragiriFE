    ...
    return (
        <div>
            <div className="dashboarddiv">
                ...
                >
                    <button style={{ cursor: 'pointer' }} onClick={() => navigation(-1)}>Back</button>
                    <button onClick={() => down()}>Print</button>
                ...
                <div className="main-certificate" id="receipt" ref={componentRef}>
                        ...
                        <div className="main-head-container">
                            ...
                            <span className="head-name">
                                ...
                                <h5 style={{ color: 'black' }}>
                                    कार्यालये - 07489087040, संपर्क -9425563160, 9301001473
                                </h5>
                    ...
                    <div className="reciptimg">
                        <h2 style={{ textAlign: 'center' }}>पावती</h2>
                        {isData?.LedgerNo ? (
                            <>
                    ...
                    <div className="signature-point" style={{ marginTop: '3rem' }}>

                        <div className="main_div_signature">
                            <p> हस्ताक्षर अध्यक्ष</p>
                        </div>
